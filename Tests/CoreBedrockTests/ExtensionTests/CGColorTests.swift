...
struct CGColorTests {
    ...
    @Test func testArgbColor() {
        ...
        // Middle values
        color = CGColor.from(red: 128, green: 64, blue: 192, alpha: 0.5)
        expectedARGB = 0x808040C0
        #expect(color.argbColor == expectedARGB)

        // Maximum values
        color = CGColor.from(red: 255, green: 255, blue: 255, alpha: 1.0)
        expectedARGB = 0xFFFFFFFF
        #expect(color.argbColor == expectedARGB)

        // Test Monochrome color
        let grayColorSpace = CGColorSpaceCreateDeviceGray()
        let monochromeColor = CGColor(colorSpace: grayColorSpace, components: [0.5, 0.8])!
        let expectedMonochromeARGB: UInt32 = 0xCC808080 // Alpha 0.8 (204), Gray 0.5 (128)
    ...
    @Test func testRgbaColor() {
        ...
        // Middle values
        color = CGColor.from(red: 128, green: 64, blue: 192, alpha: 0.5)
        expectedRGBA = 0x8040C080
        #expect(color.rgbaColor == expectedRGBA)

        // Maximum values
        color = CGColor.from(red: 255, green: 255, blue: 255, alpha: 1.0)
        expectedRGBA = 0xFFFFFFFF
        #expect(color.rgbaColor == expectedRGBA)

        // Test Monochrome color
        let grayColorSpace = CGColorSpaceCreateDeviceGray()
        let monochromeColor = CGColor(colorSpace: grayColorSpace, components: [0.5, 0.8])!
        let expectedMonochromeRGBA: UInt32 = 0x808080CC // Red 0.5 (128), Green 0.5 (128), Blue 0.5 (128), Alpha 0.8 (204)
