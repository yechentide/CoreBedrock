...
struct CGColorTests {
    ...
    func testArgbColor() throws {
        ...
        let monochromeColor = try #require(CGColor(colorSpace: grayColorSpace, components: [0.5, 0.8]))
        ...
        let unsupportedColor = try #require(CGColor(colorSpace: cmykColorSpace, components: cmykComponents))
        #expect(unsupportedColor.argbColor == nil)
    }

    @Test
    func testArgbHexString() throws {
        // Minimum values
        var color = CGColor.from(red: 0, green: 0, blue: 0, alpha: 0.0)
