...
struct FileManagerTests {
    @Test
    func testCreateDirectoryIfMissing() async throws {
    ...
    @Test
    func testDeleteFileIfExists() async throws {
        let tempDir = FileManager.default.temporaryDirectory
    ...
    @Test
    func testDirExists() async throws {
        let tempDir = FileManager.default.temporaryDirectory
        let testDir = tempDir.appendingPathComponent(UUID().uuidString)
        let testFile = tempDir.appendingPathComponent(UUID().uuidString)
    ...
    @Test
    func testIsMCWorldDir() async throws {
        let tempDir = FileManager.default.temporaryDirectory
