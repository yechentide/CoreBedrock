...
struct CBBinaryWriterTests {
    ...
    func testInitialization() throws {
        ...
        #expect(writer.data == Data([UInt8].init(repeating: 0, count: 50)))
    }
    ...
    @Test
    func testWriteBytesArray() throws {
        let writer = CBBinaryWriter()
    ...
    @Test
    func testWriteFixedWidthIntegerLittleEndian() throws {
        ...
        let int64Val: Int64 = Int64(bitPattern: 0xFEDC_BA98_7654_3210) // Expected: 0x10, 0x32...
        try writer.write(int64Val)
        #expect(writer.toByteArray().suffix(8) == [0x10, 0x32, 0x54, 0x76, 0x98, 0xBA, 0xDC, 0xFE])
    }

    @Test
    func testWriteFixedWidthIntegerBigEndian() throws {
        ...
        let int64Val: Int64 = Int64(bitPattern: 0xFEDC_BA98_7654_3210) // Expected: 0xFE, 0xDC...
        try writer.write(int64Val)
        #expect(writer.toByteArray().suffix(8) == [0xFE, 0xDC, 0xBA, 0x98, 0x76, 0x54, 0x32, 0x10])
    }
    
    @Test
    func testWriteFloatLittleEndian() throws {
        let writer = CBBinaryWriter(littleEndian: true)
    ...
    @Test
    func testWriteFloatBigEndian() throws {
        let writer = CBBinaryWriter(littleEndian: false)
        let value: Float = 3.1415927
        try writer.write(value)
    ...
    @Test
    func testWriteDoubleLittleEndian() throws {
        let writer = CBBinaryWriter(littleEndian: true)
        let value: Double = 3.215000000007247
        try writer.write(value)
        #expect(writer.toByteArray() == [0x77, 0x5E, 0x85, 0xEB, 0x51, 0xB8, 0x09, 0x40])
    }

    @Test
    func testWriteDoubleBigEndian() throws {
        let writer = CBBinaryWriter(littleEndian: false)
        let value: Double = 3.215000000007247
        try writer.write(value)
    ...
    @Test
    func testWriteNBTStringLittleEndian() throws {
        let writer = CBBinaryWriter(littleEndian: true)
        let str = "Hello"
    ...
    @Test
    func testWriteNBTStringBigEndian() throws {
        let writer = CBBinaryWriter(littleEndian: false)
        let str = "Test"
        try writer.writeNBTString(str)
    ...
    @Test
    func testWriteNBTStringTooLong() throws {
        let writer = CBBinaryWriter()
