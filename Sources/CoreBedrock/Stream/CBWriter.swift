...
public final class CBWriter {
    ...
    private var _nodes: [CBWriterNode]
    
    /// Initializes a new instance of the `CBWriter` class.
    /// - Parameters:
    ...
    /// with `CBWriter`, constructing `NbtTag` objects defeats the purpose of this class. If you
